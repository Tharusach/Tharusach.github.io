...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/tharuka-wickramaarachchi-b69b3b256?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@__tha.ruu__",
    icon: Instagram,
    url: "https://www.instagram.com/__tha.ruu__",
    color: "#E4405F",
