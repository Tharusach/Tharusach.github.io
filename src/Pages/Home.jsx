...
const WORDS = ["Software Engineering Undergraduate", "Tech Enthusiast"];
const TECH_STACK = ["React", "Angular", "Node.js", "Tailwind"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/Szachii" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/tharuka-wickramaarachchi-b69b3b256/" },
  { icon: Instagram, link: "https://www.instagram.com/__tha.ruu__" }
];
...
const Home = () => {
  ...
  return (
    <div className= " pl-3 min-h-screen bg-[#030014] overflow-hidden" id="Home">
