        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
              a creative Full-Stack Developer specializing in React, Vite, Tailwind CSS, Node.js, Express and
               modern web technologies. I craft responsive, user-friendly web applications by blending design and
                functionality. Passionate about innovation, I stay updated with the latest trends to deliver
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="https://drive.google.com/file/d/1XvxJsGqHNX_HE7plqOVHXjgZtfTYZz6O/view?usp=sharing" className="w-full">
              <button 
                data-aos="fade-up"
                data-aos-duration="800"
